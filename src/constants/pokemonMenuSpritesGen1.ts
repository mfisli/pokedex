...
const menuSprites: MenuSprite[] = [
    ...
    {
        type: "quadruped",
        pokemonIdList: [19, 20, 37, 38, 58, 59, 77, 78, 79, 11, 128, 133, 134, 135, 136],
        fileName: quadruped

    },
    {
        type: "rhydon",
        pokemonIdList: [4, 5, 6, 27, 28, 29, 30, 31, 32, 33, 34, 41, 42, 50, 51, 52, 53, 54, 55, 56, 60, 61, 62, 63, 64, 65, 66, 67, 68, 74, 75, 76, 80, 88, 89, 92, 93, 94, 96, 97, 104, 105, 106, 107, 108, 109, 110, 112, 115, 122, 124, 125, 126, 132, 137, 143, 150, 151],
        fileName: rhydon
